    ...
    render() {
        return (
            <div className={"references"}>
                ...
                <ul>
                    <li>online na <a href="http://logic.stanford.edu/intrologic/lessons/lessons.html">http://logic.stanford.edu/intrologic/lessons/lessons.html</a></li>
                    <li>podobný existujúci nástroj na univerzite Stanford</li>
                    <li>našim cieľom je vytvoriť jednotný nástroj na zadávanie a riešenie všetkých cvičení pre logiku prvého rádu aké obsahuje tento nástroj</li>
                </ul>
                ...
                <ul>
                    <li>dokumentácia online <a href="http://facebook.github.io/jest/docs/en/getting-started.html">http://facebook.github.io/jest/docs/en/getting-started.html</a></li>
